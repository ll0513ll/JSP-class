...
%>
<form action="process_member.jsp" method = "post" enctype = "application/x-www-form-urlencoded">
	<table>
		<tr>
		<td>아이디</td>
		<td>
		<input type="text" name="id" id="userid" readonly="readonly" onclick = "ID_Check()" value="<%=vo.getId() %>">
		<input type="text" name="" id="message" disabled="disabled">
		</td>
		<td><button onclick="return id_check_with_ajax(0)">ID check</button></td><td>
		...
		<tr><td>우편번호</td>
		<td>
		<input type="text" onclick = "zip_check()" name="zip1" id = "zip1" readonly="readonly" value="<%=vo.getZip1() %>"size="3">-
		<input type="text" name="zip2" onclick="zip_check()"readonly="readonly" id = "zip2" value="<%=vo.getZip2() %>"size="3">
		<span id = "zipmsg"></span>
		</td>
		<td><button onclick="return id_check_with_ajax(1)">우편번호 검색</button></td>
